...
var pump = false;
var zones = require(path.resolve(__dirname, 'config/zones.json'));
var schedules = require(path.resolve(__dirname, 'config/schedule.json'));
var isRunning = false;
...
function checkTime() {
  var d = new Date();
  var curDay = d.toLocaleDateString('en-US', { weekday: 'long' });
  var shouldRun = false;
